...
export default function PlayerProfilSayaPage() {
  ...
  const displayName = user?.name || assessment?.player_name || "—";
        ...
        <div className="lg:col-span-1 space-y-5">
            ...
            <div className="px-6 pb-6">
              ...
              <div className="text-center">
                ...
                <div className="mt-3 flex flex-wrap items-center justify-center gap-2">
                  <span className="inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-bold bg-blue-50 text-blue-700 border border-blue-100 uppercase tracking-wide">
                    <Shield size={11} /> Peserta
                  </span>
                  {isKacamata && (
          ...
          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-5">
            ...
            <div className="space-y-3">
              ...
              <InfoField label="Peran" value="Peserta (Player)" />
              <InfoField label="Pengguna Kacamata" value={isKacamata ? "Ya" : "Tidak"} />
              {assessment?.contingent && (
                <div className="border-t border-gray-100 pt-3 mt-1">
                  <InfoField label="Kontingen" value={assessment.contingent} />
                </div>
              )}
              {assessment?.sport_branch && (
                <InfoField label="Cabang Olahraga" value={assessment.sport_branch} />
              )}
              {assessment?.snapshot?.age && (
                <InfoField label="Usia" value={`${assessment.snapshot.age} tahun`} />
              )}
          ...
          {assessment && (
            <>
                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:items-center gap-5">
                    ...
                    <div className="flex-1">
                      <div className="flex flex-wrap items-center gap-3 mb-2">
                        <span
                          className={`rounded-full px-5 py-1.5 text-sm font-extrabold ${
                            RISK_CONFIG[assessment.risk_label].badge
                          }`}
                        >
                        ...
                        <span
                          className={`text-sm font-bold ${
                            RISK_CONFIG[assessment.risk_label].text
                          }`}
                        >
                      ...
                      <div className="flex flex-wrap gap-3 text-xs text-gray-500">
                        ...
                        >
                          {assessment.is_valid ? (
                            <>
                              <CheckCircle2 size={11} /> Berlaku hingga{" "}
                              {formatDate(assessment.valid_until!)}
                            </>
                          ) : (
                            <>
                    ...
                    <div className="bg-red-50 border border-red-200 rounded-2xl p-5">
                      ...
                      <div className="space-y-2">
                        {assessment.red_flags!.map((f, i) => (
                          <div
                            key={i}
                            className="bg-white rounded-lg border border-red-100 px-3 py-2"
                          >
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  {assessment.medical_review?.reviewed_at ? (
                    <div className="space-y-3">
                      ...
                      <p className="text-[10px] text-gray-400 flex items-center gap-1">
                        <Clock size={10} />
                        {formatDateTime(assessment.medical_review.reviewed_at)}
                      </p>
                    </div>
                  ) : (
                ...
                {assessment.snapshot && (
                  <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-5">
                    <h3 className="text-sm font-bold text-gray-700 mb-3">Data Fisik</h3>
              ...
              {assessment.recommendation && (
                <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
                  <h3 className="text-sm font-bold text-gray-800 mb-3 flex items-center gap-2">
                    <ClipboardList size={14} className="text-[#b71c1c]" /> Rekomendasi
                  </h3>
